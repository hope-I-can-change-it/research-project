...
def lbfgs(opfunc, x, state, maxIter=100, learningRate=1, do_verbose=True, history=None):
  ...
  """
    ...
    while nIter < maxIter:
        ...
        if history is not None:
            history["loss"].append(float(f.numpy()))
    ...
    return x, f_hist, currentFuncEval, history
